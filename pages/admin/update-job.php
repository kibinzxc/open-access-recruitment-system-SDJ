...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Decode JSON arrays
    $responsibilities = capitalizeWordsArray(json_decode($_POST['responsibilities'], true));
    $qualifications = capitalizeWordsArray(json_decode($_POST['qualifications'], true));
